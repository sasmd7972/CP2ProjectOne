...
//-----------------------------------------------------------
    ...
    for (int i = 0; i < 18; i++) {
        ...
        //cout << playerCredits.at(i) << endl; TESTING
    ...
    do {
        ...
        switch (menuChoice) {//Determines which of the menu options was chosen, if any
            ...
            case 'c':
                ...
                cout << setfill('-') << setw(60) << "-" << endl;
                cout << "Welcome " << playerHold.getName() << endl;
                            ...
                            if (requestedSeat == "front") {
                                if ((playerCredits.at(playerId) < 5) && (playerCredits.at(playerId) != -1)) {
                                    ...
                                    if (!(purplePickup.isFull(FrontSeat5))) {
                                        playerHold.createReservation(FrontSeat5, 1);
                                        ...
                                        playerHold.createReservation(FrontSeat5, 2);
                                        ...
                                        playerHold.createReservation(FrontSeat5, 5);
                                        ...
                                        playerHold.createReservation(FrontSeat5, 8);
                                        ...
                                        playerHold.createReservation(FrontSeat5, 11);
                                        ...
                                        playerHold.createReservation(FrontSeat5, 15);
                                ...
                                if ((playerCredits.at(playerId) < 3) && (playerCredits.at(playerId) != -1)) {
                                    ...
                                    if ((!(redCompact.isFull(BackSeatL3)))) {
                                        playerHold.createReservation(BackSeatL3, 3);
                                        ...
                                        playerHold.createReservation(BackSeatL3, 6);
                                        ...
                                        playerHold.createReservation(BackSeatL3, 9);
                                        ...
                                        playerHold.createReservation(BackSeatR3, 4);
                                        ...
                                        playerHold.createReservation(BackSeatR3, 7);
                                        ...
                                        playerHold.createReservation(BackSeatR3, 10);
                                ...
                                if ((playerCredits.at(playerId) < 2) && (playerCredits.at(playerId) != -1)) {
                                    ...
                                    if ((!(blueSedan.isFull(BackSeatL2)))) {
                                        playerHold.createReservation(BackSeatL2, 12);
                                        ...
                                        playerHold.createReservation(BackSeatL2, 16);
                                        ...
                                        playerHold.createReservation(BackSeatR2, 14);
                                    ...
                                    if ((!(greenSedan.isFull(BackSeatR2)))) {
                                        playerHold.createReservation(BackSeatR2, 18);
                                ...
                                if ((playerCredits.at(playerId) < 1) && (playerCredits.at(playerId) != -1)) {
                                    ...
                                    if ((!(blueSedan.isFull(BackSeatM1)))) {
                                        playerHold.createReservation(BackSeatM1, 13);
                                        ...
                                        playerHold.createReservation(BackSeatM1, 17);
                                ...
                                if (requestedSeat == "front") {
                                    ...
                                    if ((playerCredits.at(playerId) < 3) && (playerCredits.at(playerId) != -1)) {
                                        ...
                                        if (!redCompact.isFull(BackSeatL3)) {
                                            ...
                                            cout
                                                    << "All side seats in this vehicle are unavailable. Returning to Menu"
                                                    << endl;
                                            stillInCat = false;
                                        }
                                    }
                                ...
                                if (requestedSeat == "front") {
                                    ...
                                    if ((playerCredits.at(playerId) < 1) && (playerCredits.at(playerId) != -1)) {
                                        ...
                                        if (!greenSedan.isFull(BackSeatM1)) {
                                            ...
                                            cout
                                                    << "All middle seats in this vehicle are unavailable. Returning to Menu"
                                                    << endl;
                                            stillInCat = false;
                                        }
                                    }
            ...
            case 'm':
                ...
                if (requestedVehicle == "purple pickup") {//There is only one seat possible in this vehicle so no seat selection is needed
                        if (purplePickup.GetFilled().at(1)) {
                            ...
                            playerHold.modifyReservation(FrontSeat5, 1);
                            purplePickup.setSeat(playerHold, FrontSeat5);
                            cout << "Successful reservation. Your Reservation ID is "
                                 << playerHold.getID()
                                 << endl;
                    ...
                    if (requestedSeat == "front") {
                            if (redCompact.isFull(FrontSeat5)) {
                                ...
                                playerHold.modifyReservation(FrontSeat5, 2);
                                redCompact.setSeat(playerHold, FrontSeat5);
                                cout << "Successful reservation. Your Reservation ID is "
                                     << playerHold.getID()
                                     << endl;
                            ...
                            if (!redCompact.isFull(BackSeatL3)) {
                                ...
                                playerHold.modifyReservation(BackSeatR3, 4);
                                redCompact.setSeat(playerHold, BackSeatR3);
                                cout << "Successful reservation. Your Reservation ID is "
                                     << playerHold.getID()
                                     << endl;
                    ...
                    if (requestedSeat == "front") {
                            if (blueCompact.isFull(FrontSeat5)) {
                                ...
                                playerHold.modifyReservation(FrontSeat5, 5);
                                blueCompact.setSeat(playerHold, FrontSeat5);
                                cout << "Successful reservation. Your Reservation ID is "
                                     << playerHold.getID()
                                     << endl;
                            ...
                            if (!blueCompact.isFull(BackSeatL3)) {
                                ...
                                playerHold.modifyReservation(BackSeatR3, 7);
                                blueCompact.setSeat(playerHold, BackSeatR3);
                                cout << "Successful reservation. Your Reservation ID is "
                                     << playerHold.getID()
                                     << endl;
                    ...
                    if (requestedSeat == "front") {
                            ...
                            if (yellowCompact.isFull(FrontSeat5)) {
                                ...
                                playerHold.modifyReservation(FrontSeat5, 8);
                                yellowCompact.setSeat(playerHold, FrontSeat5);
                                cout << "Successful reservation. Your Reservation ID is "
                                     << playerHold.getID()
                                     << endl;
                            ...
                            if (!yellowCompact.isFull(BackSeatL3)) {
                                ...
                                playerHold.modifyReservation(BackSeatR3, 10);
                                yellowCompact.setSeat(playerHold, BackSeatR3);
                                cout << "Successful reservation. Your Reservation ID is "
                                     << playerHold.getID()
                                     << endl;
                    ...
                    if (requestedSeat == "front") {
                            if (blueSedan.isFull(FrontSeat5)) {
                                ...
                                playerHold.modifyReservation(FrontSeat5, 11);
                                blueSedan.setSeat(playerHold, FrontSeat5);
                                cout << "Successful reservation. Your Reservation ID is "
                                     << playerHold.getID()
                                     << endl;
                            ...
                            if (!blueSedan.isFull(BackSeatL2)) {
                                ...
                                playerHold.modifyReservation(BackSeatR2, 14);
                                blueSedan.setSeat(playerHold, BackSeatR2);
                                cout << "Successful reservation. Your Reservation ID is "
                                     << playerHold.getID()
                                     << endl;
                    ...
                    if (requestedSeat == "front") {
                            if (greenSedan.isFull(FrontSeat5)) {
                                ...
                                playerHold.modifyReservation(FrontSeat5, 15);
                                greenSedan.setSeat(playerHold, FrontSeat5);
                                cout << "Successful reservation. Your Reservation ID is "
                                     << playerHold.getID()
                                     << endl;
                            ...
                            if (!greenSedan.isFull(BackSeatL2)) {
                                ...
                                playerHold.modifyReservation(BackSeatR2, 18);
                                greenSedan.setSeat(playerHold, BackSeatR2);
                                cout << "Successful reservation. Your Reservation ID is "
                                     << playerHold.getID()
                                     << endl;
